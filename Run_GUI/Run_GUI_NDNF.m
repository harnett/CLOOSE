function varargout = Run_GUI_NDNF(varargin)
% RUN_GUI_NDNF MATLAB code for Run_GUI_NDNF.fig
%      RUN_GUI_NDNF, by itself, creates a new RUN_GUI_NDNF or raises the existing
%      singleton*.
%
%      H = RUN_GUI_NDNF returns the handle to a new RUN_GUI_NDNF or the handle to
%      the existing singleton*.
%
%      RUN_GUI_NDNF('CALLBACK',hObject,evarduinarduientData,handles,...) calls the local
%      function named CALLBACK in RUN_GUI_NDNF.M with the given input arguments.
%
%      RUN_GUI_NDNF('Property','Value',...) creates a new RUN_GUI_NDNF or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Run_GUI_NDNF_OpeningFcn gets called.  An
...
% Edit the above text to modify the response to help Run_GUI_NDNF

% Last Modified by GUIDE v2.5 17-Jun-2024 11:23:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Run_GUI_NDNF_OpeningFcn, ...
                   'gui_OutputFcn',  @Run_GUI_NDNF_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Run_GUI_NDNF is made visible.
function Run_GUI_NDNF_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to fnroiigure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Run_GUI_NDNF (see VARARGIN)
...
% Choose default command line output for Run_GUI_NDNF
handles.output = hObject;
handles.ROIdrawNum = 0;
% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Run_GUI_NDNF wait for user response (see UIRESUME)
...
function varargout = Run_GUI_NDNF_OutputFcn(hObject, eventdata, handles) 

...
h2 = handles.axes3;
plot(StimData.RoiPerFrame(1, 16515:16605)./max(StimData.RoiPerFrame(1, :)) + 1,'r', 'Parent', h2)
hold(h2,'on')
plot(StimData.RoiPerFrame(2, 16515:16605)./max(StimData.RoiPerFrame(2, :)),'b', 'Parent', h2)

h3 = handles.axes1;
plot(StimData.Rotation(1, 16515:16605),'k', 'Parent', h3)
hold(h3,'on')
ylim(h3, [0 90])
